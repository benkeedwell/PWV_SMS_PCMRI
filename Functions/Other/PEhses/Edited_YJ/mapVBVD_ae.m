function twix_obj = mapVBVD_ae(filename,varargin)
%
%  BK: THIS VERSION OF MAPVBVD WAS EDITED BY YANG JI TO REMOVE
%  OVERSAMPLING FOR SCANS WITH ASYMMETRIC ECHO
%
...
for s=1:NScans
    ...
    twix_obj{s}.image         = twix_map_obj_ae(arg,'image',filename,version,rstraj);
    twix_obj{s}.noise         = twix_map_obj_ae(arg,'noise',filename,version);
    twix_obj{s}.phasecor      = twix_map_obj_ae(arg,'phasecor',filename,version,rstraj);
    twix_obj{s}.phasestab     = twix_map_obj_ae(arg,'phasestab',filename,version,rstraj);
    twix_obj{s}.phasestabRef0 = twix_map_obj_ae(arg,'phasestab_ref0',filename,version,rstraj);
    twix_obj{s}.phasestabRef1 = twix_map_obj_ae(arg,'phasestab_ref1',filename,version,rstraj);
    twix_obj{s}.refscan       = twix_map_obj_ae(arg,'refscan',filename,version,rstraj);
    twix_obj{s}.refscanPC     = twix_map_obj_ae(arg,'refscan_phasecor',filename,version,rstraj);
    twix_obj{s}.refscanPS     = twix_map_obj_ae(arg,'refscan_phasestab',filename,version,rstraj);
    twix_obj{s}.refscanPSRef0 = twix_map_obj_ae(arg,'refscan_phasestab_ref0',filename,version,rstraj);
    twix_obj{s}.refscanPSRef1 = twix_map_obj_ae(arg,'refscan_phasestab_ref1',filename,version,rstraj);
    twix_obj{s}.RTfeedback    = twix_map_obj_ae(arg,'rtfeedback',filename,version,rstraj);
    twix_obj{s}.vop           = twix_map_obj_ae(arg,'vop',filename,version); % tx-array rf pulses
    
    %---------------------------------------------------------------------
    % yang, add here for aSymmetric echo downsampling and oversampling
    % factor
    twix_obj{s}.image.lBaseResolution=twix_obj{s}.hdr.Phoenix.sKSpace.lBaseResolution;
    twix_obj{s}.refscan.lBaseResolution=twix_obj{s}.hdr.Phoenix.sKSpace.lBaseResolution;

    twix_obj{s}.image.ReadoutOSFactor = twix_obj{s}.hdr.Dicom.flReadoutOSFactor;%0802
    twix_obj{s}.refscan.ReadoutOSFactor = twix_obj{s}.hdr.Dicom.flReadoutOSFactor;%0802
    %---------------------------------------------------------------------
